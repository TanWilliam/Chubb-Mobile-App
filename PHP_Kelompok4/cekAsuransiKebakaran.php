  ...
  //  $_POST['IDAsuransiKebakaran'] = 'IDAsuransiKebakaran';
    ...
    if(mysqli_num_rows($q)>0){
        ...
        while($r=mysqli_fetch_array($q)){
            ...
            $asuransikebakaran["NoHPAK"] = $r["NoHPAK"];
            $asuransikebakaran["EmailAK"] = $r["EmailAK"];
            $asuransikebakaran["LokasiPropertiAK"] = $r["LokasiPropertiAK"];
            $asuransikebakaran["HargaPropertiAK"] = $r["HargaPropertiAK"];
